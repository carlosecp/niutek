...
const testingValues = {
	p_cod_tipo_credito: 1,
	p_cod_fuente_fondo: 1,
	p_nombre: 'p_nombre',
	p_descripcion: 'p_descripcion',
	p_cod_moneda: 1,
	p_tasa_interes_minima: (10).toFixed(2),
	p_tasa_interes_maxima: (10).toFixed(2),
	p_monto_minimo: (10).toFixed(2),
	p_monto_maximo: (10).toFixed(2),
	p_plazo_minimo: 1,
	p_plazo_maximo: 1,
	p_cod_frec_plazo_min: 1,
	p_cod_frec_plazo_max: 1,
	p_cod_frecuencia_pago: 1,
	p_porc_aportacion: 1,
	p_cod_tipo_cuota: 1,
	p_cod_aplica_grupo: 1,
